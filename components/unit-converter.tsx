  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-200 dark:bg-blue-700">
      ...
      <div className="max-w-md w-full p-5 bg-rose-300 rounded-lg shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 bg-blue-200 gap-4 p-5">
          ...
          <Button
            type="button"
            className="w-48 justify-center bg-blue-500 text-primary-foreground font-bold text-black hover:bg-rose-400 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
